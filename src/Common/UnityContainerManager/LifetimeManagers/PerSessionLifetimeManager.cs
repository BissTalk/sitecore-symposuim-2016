...
namespace SymDemo.UnityContainerManager.LifetimeManagers
{
    ...
    public class PerSessionLifetimeManager : LifetimeManager
    {
        ...
        {
            object result;
            if (SessionObjectStore.Current == null) throw new NoNullAllowedException("RequestContextObjectStore.Current cannot be null");
            return SessionObjectStore.Current.TryGetValue(_guid, out result)
                ? result
                : null;
        }
        ...
        public override void SetValue(object newValue)
        {
            ...
            SessionObjectStore.Current.AddOrUpdate(_guid, newValue, (k, v) => newValue);
        }
        ...
        public override void RemoveValue()
        {
            object val;
            if (SessionObjectStore.Current == null) throw new NoNullAllowedException("RequestContextObjectStore.Current cannot be null");
            SessionObjectStore.Current.TryRemove(_guid, out val);
        }
    }
}